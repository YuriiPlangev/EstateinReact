    ...
    <div className="possibilities__container" id="propertyCards">
      ...
      properties.map((property) => (
        <article key={property.id} className="featured__card">
          <img src={property.images[0]} alt="" className="featured__card--img" />
          <h3 className="featured__card--title">{property.name}</h3>
          <p className="featured__card--desc">
            {property.description}
            <span>
              <a href="#" className="featured__card--link">Read more</a>
            </span>
          </p>
      ...
      <div className="no-results">
        ...
        <p>
          Please try adjusting the filters or <Link to="/contact">Contact Us</Link> for more options.
        </p>
      </div>
      )
      }
