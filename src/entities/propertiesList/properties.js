...

{
    ...
    features: [
        ...
        "Situated in a prestigious neighborhood known for its upscale amenities and exclusive community.",
        "Family-friendly and pet-welcoming environment, ideal for residents of all ages.",
        "Resort-style amenities including a luxurious swimming pool, a basketball court, a tennis court, and a mini football field for active lifestyles.",
    ],
    images :
    [
        "/images/prop/1.png",
...
{
    id: 2,
    name: "Stylish Oasis in Downtown",
    bedrooms: "2",
    bathrooms: "3",
    area: "90",
    price: "620000",
    ...
    features: [
        ...
        "Dedicated barbecue area for hosting memorable gatherings with family and friends.",
        "Exclusive dog park designed for safe and enjoyable walks and playtime with your furry companions.",
    ],
    images :
    [
        "/images/prop/2.1.png",
...
},
{
    ...
    features: [
        ...
        "Family-friendly environment, welcoming both children and your furry companions.",
        "Modern gym equipped with state-of-the-art facilities to support an active lifestyle.",
    ],
    images :
    [
...
{
    id: 5,
    name: "Cosy Luxury villa Tilal Alghaf",
    bedrooms: "4",
    bathrooms: "3",
    area: "186",
    price: "900000" ,
    ...
    features: [
        ...
        "A kids' play area provides a safe and entertaining space for children.",
        "Dedicated parking space for one vehicle ensures convenience.",
        "24/7 security staff and CCTV surveillance guarantee safety.",
        "Pet-friendly environment welcomes furry companions for a comfortable stay. ",
    ],
    images :
    [
        "/images/prop/5.1.png",
...
},
{
    ...
    features: [
        ...
        "Enjoy stunning views and fresh air from the spacious terrace.",
