...
function Properties () {
  ...
  <section className="properties-intro">
    ...
    <div className="properties__filter">
      <form action="" className="properties__filter-form">
        <input
          type="text"
          placeholder="Search For A Property"
          className="properties__filter-search"
        />
        <button className="properties__filter-button">
          <svg
            width={18}
            height={18}
            viewBox="0 0 18 18"
      ...
      <form action="" className="properties__filter-selects" id="filterForm">
        <fieldset className="properties__fieldset">
          <svg
            width={18}
            height={21}
            viewBox="0 0 18 21"
        ...
        <fieldset className="properties__fieldset">
          ...
          >
            ...
            <option value="apartaments">Apartment</option>
        ...
        <fieldset className="properties__fieldset">
          ...
          >
            <path
              d="M11.4004 4.5C10.1577 4.5 9.15039 5.50736 9.15039 6.75C9.15039 7.99264 10.1577 9 11.4004 9C12.643 9 13.6504 7.99264 13.6504 6.75C13.6504 5.50736 12.643 4.5 11.4004 4.5Z"
              fill="#999999"
            />
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M0.900391 1.875C0.900391 0.839466 1.73986 0 2.77539 0H20.0254C21.0609 0 21.9004 0.839466 21.9004 1.875V11.625C21.9004 12.6605 21.0609 13.5 20.0254 13.5H2.77539C1.73986 13.5 0.900391 12.6605 0.900391 11.625V1.875ZM7.65039 6.75C7.65039 4.67893 9.32932 3 11.4004 3C13.4715 3 15.1504 4.67893 15.1504 6.75C15.1504 8.82107 13.4715 10.5 11.4004 10.5C9.32932 10.5 7.65039 8.82107 7.65039 6.75ZM18.1504 6C17.7362 6 17.4004 6.33579 17.4004 6.75V6.7575C17.4004 7.17171 17.7362 7.5075 18.1504 7.5075H18.1579C18.5721 7.5075 18.9079 7.17171 18.9079 6.7575V6.75C18.9079 6.33579 18.5721 6 18.1579 6H18.1504ZM3.90039 6.75C3.90039 6.33579 4.23618 6 4.65039 6H4.65789C5.0721 6 5.40789 6.33579 5.40789 6.75V6.7575C5.40789 7.17171 5.0721 7.5075 4.65789 7.5075H4.65039C4.23618 7.5075 3.90039 7.17171 3.90039 6.7575V6.75Z"
              fill="#999999"
            />
            <path
              d="M1.65039 15C1.23618 15 0.900391 15.3358 0.900391 15.75C0.900391 16.1642 1.23618 16.5 1.65039 16.5C7.05044 16.5 12.2806 17.2222 17.2502 18.5749C18.4407 18.899 19.6504 18.0168 19.6504 16.7551V15.75C19.6504 15.3358 19.3146 15 18.9004 15H1.65039Z"
              fill="#999999"
            />
          </svg>
          <select
        ...
        <fieldset className="properties__fieldset">
          ...
          >
            <path
              d="M10.9775 0.602166C10.744 0.465945 10.4552 0.465945 10.2217 0.602166L1.59961 5.63172L10.5996 10.8817L19.5996 5.63172L10.9775 0.602166Z"
              fill="#999999"
            />
            <path
              d="M20.3496 6.93078L11.3496 12.1808V21.1808L19.9775 16.1478C20.2079 16.0134 20.3496 15.7668 20.3496 15.5V6.93078Z"
              fill="#999999"
            />
            <path
              d="M9.84961 21.1808V12.1808L0.849609 6.93078V15.5C0.849609 15.7668 0.991293 16.0134 1.22171 16.1478L9.84961 21.1808Z"
              fill="#999999"
            />
          </svg>
          <select
