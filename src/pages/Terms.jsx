...
return (
  ...
  <p>
    ...
    with this Privacy Policy. T
  </p>
  <h2 className="terms__title">Interpretation and Definitions</h2>
  ...
  <ul className="terms__list">
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Account</span> means a unique
        account created for You to access our Service or parts of our Service.
      </p>
    </li>
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Affiliate</span> means an entity
    ...
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Company</span> (referred to as
        either "the Company", "We", "Us" or "Our" in this Agreement) refers to
        Estatein, 123 Estatein Plaza, City Center, Metropolis.
      </p>
    </li>
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Cookies</span> are small files
    ...
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Country</span> refers to: United
        Arab Emirates
      </p>
    </li>
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Device</span> means any device
    ...
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Personal Data</span> is any
        information that relates to an identified or identifiable individual.
      </p>
    </li>
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Service</span> refers to the
        Website.
      </p>
    </li>
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Service Provider</span> means any
    ...
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Usage Data</span> refers to data
    ...
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">Website</span> refers to
        Estatein.com, accessible from{" "}
        <Link
         to="/" 
    ...
    <li className="terms__item">
      <p>
        <span className="terms__item--strong">You</span> means the individual
  ...
  <h2 className="terms__title">Collecting and Using Your Personal Data</h2>
  ...
  <ul>
    <li>
      <p>
        <span className="terms__item--strong">Cookies or Browser Cookies.</span>{" "}
    ...
    <li>
      <p>
        <span className="terms__item--strong">Web Beacons.</span> Certain
  ...
  <ul>
    <li>
      <p>
        <span className="terms__item--strong">
    ...
    <li>
      <p>
        <span className="terms__item--strong">Functionality Cookies</span>
      </p>
      <p>Type: Persistent Cookies</p>
      <p>Administered by: Us</p>
      <p>
  ...
  <ul>
    ...
    <li>
      <p>
        <span className="terms__item--strong">To manage Your Account:</span> to
    ...
    <li>
      <p>
        <span className="terms__item--strong">To contact You:</span> To contact
    ...
    <li>
      <p>
        <span className="terms__item--strong">To provide You</span> with news,
    ...
    <li>
      <p>
        <span className="terms__item--strong">To manage Your requests:</span> To
        attend and manage Your requests to Us.
      </p>
    </li>
    <li>
      <p>
        <span className="terms__item--strong">For business transfers:</span> We
    ...
    <li>
      <p>
        <span className="terms__item--strong">For other purposes</span>: We may
  ...
  <ul>
    <li>
      <span className="terms__item--strong">With Service Providers:</span> We
      may share Your personal information with Service Providers to monitor and
    ...
    <li>
      <span className="terms__item--strong">With Affiliates:</span> We may share
    ...
    <li>
      <span className="terms__item--strong">With business partners:</span> We
      may share Your information with Our business partners to offer You certain
      products, services or promotions.
    </li>
    <li>
      <span className="terms__item--strong">With other users:</span> when You
    ...
    <li>
      <span className="terms__item--strong">With Your consent</span>: We may
  ...
  <h2 className="terms__title">Links to Other Websites</h2>
  <p>
  ...
  <h2 className="terms__title">Changes to this Privacy Policy</h2>
  <p>
  ...
  <h2 className="terms__title">Contact Us</h2>
  <p>
    If you have any questions about this Privacy Policy, You can contact us:
  </p>
  <ul>
    <li>
      <p>By email: info@estatein.com</p>
    </li>
    <li>
      <p>By phone number: +1 (123) 456-7890</p>
    </li>
  </ul>
</main>
